package org.example.drafts.water_shed;
...
class ImageSegmentation {
    public void run(String[] args) throws IOException {
        // Load the image
        BufferedImage img= ImageIO.read(getClass().getClassLoader().getResource("template_img_border.tiff"));
//        String filename = args.length > 0 ? args[0] : "resources/template_img.tiff";
//        Mat srcOriginal = Imgcodecs.imread(filename);
        Mat srcOriginal = BufferedImage2Mat(img);
...
//        }
        ...
        Mat dist = new Mat();
        Imgproc.distanceTransform(bw, dist, Imgproc.DIST_L1, 3);
